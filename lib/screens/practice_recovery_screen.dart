...
class PracticeRecoveryScreen extends ConsumerWidget {
        ...
        data: (vault) {
          ...
          return currentPubkeyAsync.when(
            ...
            data: (currentPubkey) {
              ...
              return _buildContent(context, vault);
            },
          );
        },
      ),
  ...
  Widget _buildContent(BuildContext context, Vault vault) {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoCard(
            ...
            icon: Icons.people,
            title: 'Stewards',
            content: '${backupConfig.stewards.length} steward${backupConfig.stewards.length > 1 ? 's' : ''} have been assigned to help recover this vault',
          ),
          const SizedBox(height: 8),
          _buildInfoCard(
            context,
            icon: Icons.key,
            title: 'Threshold',
            content: 'You need ${backupConfig.threshold} out of ${backupConfig.totalKeys} keys to recover',
          ),
          const SizedBox(height: 8),
          _buildInfoCard(
            context,
            ...
            title: 'Status',
            content: '${backupConfig.acknowledgedStewardsCount} steward${backupConfig.acknowledgedStewardsCount > 1 ? 's' : ''} confirmed they stored their key',
          ),
          ...
          _buildStepCard(
            ...
            description: 'You (or a steward) would send a recovery request to all stewards via Nostr.',
          ),
          const SizedBox(height: 8),
          _buildStepCard(
            context,
            ...
            description: 'Stewards receive a notification and can approve or deny the request. Approved requests include their encrypted shard.',
          ),
          const SizedBox(height: 8),
          _buildStepCard(
            context,
            stepNumber: 3,
            title: 'Threshold Met',
            description: 'Once ${backupConfig.threshold} stewards approve, you have enough shards to reconstruct your vault content.',
          ),
          const SizedBox(height: 8),
          _buildStepCard(
            context,
            ...
            description: 'The app automatically reassembles the vault content using Shamir\'s Secret Sharing.',
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildBulletPoint(
                  context,
                  'Your stewards will not be notified or contacted',
                ),
                _buildBulletPoint(
                  context,
                ...
                _buildBulletPoint(
                  context,
                  'Real recovery requests expire after 24 hours',
                ),
              ],
            ),
          ),
