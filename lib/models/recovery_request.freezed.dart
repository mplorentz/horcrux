...
class _$RecoveryResponseImpl implements _RecoveryResponse {
...
// Actual shard data for reassembly (if approved)
  ...
  @override
  String toString() {
    return 'RecoveryResponse(pubkey: $pubkey, approved: $approved, respondedAt: $respondedAt, shardData: $shardData, nostrEventId: $nostrEventId, errorMessage: $errorMessage)';
  }
...
abstract class _RecoveryResponse implements RecoveryResponse {
...
class _$RecoveryRequestImpl implements _RecoveryRequest {
...
// Error message if status is failed
  ...
  @override
  String toString() {
    return 'RecoveryRequest(id: $id, vaultId: $vaultId, initiatorPubkey: $initiatorPubkey, requestedAt: $requestedAt, status: $status, threshold: $threshold, nostrEventId: $nostrEventId, expiresAt: $expiresAt, stewardResponses: $stewardResponses, errorMessage: $errorMessage, isPractice: $isPractice)';
  }
...
abstract class _RecoveryRequest implements RecoveryRequest {
