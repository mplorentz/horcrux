          ...
          data: (currentPubkey) {
            ...
            return recoveryStatusAsync.when(
              ...
              data: (recoveryStatus) {
                ...
                // (bug horcrux_app-3u7).
                final vaultHasActiveRecovery = vault.hasActiveRecovery;
                ...
                if (isVaultOwner) {
                  ...
                  // and no recovery is in progress (an in-flight recovery would race
                  // with key redistribution; horcrux_app-3u7).
                  buttons.add(
                    RowButtonConfig(
                      onPressed: () {
                        if (vaultHasActiveRecovery) {
