      ...
      data: (vault) {
        ...
        return currentPubkeyAsync.when(
          ...
          data: (currentPubkey) {
            ...
            return ref.watch(vaultDetailProvider(vaultId)).when(
                  loading: () => const SizedBox.shrink(),
                  error: (_, __) => const SizedBox.shrink(),
                  data: (currentVault) {
                    return recoveryStatusAsync.when(
                      ...
                      data: (recoveryStatus) {
                        ...
                        if (isVaultOwner) {
                          ...
                          final hasContent = currentVault is OwnedVaultDetail;
                            ...
                            RowButtonConfig(
                              onPressed: () {
                                if (hasContent) {
                                  ...
                                  final isOwnerSteward = currentVault is StewardedVaultDetail &&
                                      currentVault.latestShare != null;
                          ...
                          if (currentVault is OwnedVaultDetail) {
                            ...
                            if (backupConfig != null &&
                              ...
                              buttons.add(
                                RowButtonConfig(
                                  onPressed: () =>
                                      _showTravelModeDialog(context, ref, currentVault),
                                  icon: Icons.luggage,
                                  text: 'Travel Mode',
                                ),
                              );
                        ...
                        // Owner-as-steward: owns the vault but no owned_vaults row (content deleted).
                        final isOwnerSteward = isVaultOwner &&
                            currentVault is StewardedVaultDetail &&
                            currentVault.latestShare != null;
