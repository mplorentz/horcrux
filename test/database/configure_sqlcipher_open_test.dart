...
// registers a process-global `package:sqlite3` open override; each test file
// runs in its own isolate, so registering it here cannot leak into other
// tests that open in-memory databases.
void main() {
