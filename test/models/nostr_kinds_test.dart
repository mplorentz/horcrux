...
void main() {
  group('NostrKind', () {
    test('enum values have correct integer mappings', () {
      ...
      expect(NostrKind.requestToVanish.value, 62);
    ...
    test('fromValue returns correct enum for valid values', () {
      ...
      expect(NostrKind.fromValue(62), NostrKind.requestToVanish);
    ...
    test('isCustom correctly identifies Horcrux custom kinds', () {
      ...
      expect(NostrKind.requestToVanish.isCustom, isFalse);
    ...
    test('isStandard correctly identifies standard NIP kinds', () {
      ...
      expect(NostrKind.requestToVanish.isStandard, isTrue);
    ...
    test('toString returns formatted string', () {
      ...
      expect(
        NostrKind.requestToVanish.toString(),
        'NostrKind.requestToVanish(62)',
      );
    ...
    test('toInt extension method works correctly', () {
      ...
      expect(NostrKind.requestToVanish.toInt(), 62);
