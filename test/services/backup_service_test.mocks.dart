...
class MockVaultRepository extends _i1.Mock implements _i5.VaultRepository {
  ...
  @override
  _i6.Future<List<_i10.ShardData>> getShardsForVault(String? vaultId) =>
      (super.noSuchMethod(
        Invocation.method(
          #getShardsForVault,
          [vaultId],
...
class MockShardDistributionService extends _i1.Mock
    implements _i12.ShardDistributionService {
  ...
  @override
  _i6.Future<void> processShardErrorEvent({required _i14.Nip01Event? event}) =>
      (super.noSuchMethod(
        Invocation.method(
